...
class RolesController extends Controller
{
    ...
    public function datatable()
    {
        return Datatables::eloquent(Role::query())
            ->addColumn('action', function ($item) {
                ...
                $col .= '<a href="' . route('rbac.roles.delete', [$item]) . '" class="btn btn-xs btn-warning" onclick="return confirm(\'You sure?\')"><i class="fa fa-trash"></i></a>';
    ...
    public function postCreate(Request $request)
    {
        ...
        return redirect()->route('rbac.roles.edit', $role)->with('success', 'Created Succesful');
    }
